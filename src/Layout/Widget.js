...
const Widget = () => {
  return (
    <aside className="bg-white w-80">
      <div className='flex items-center space-x-2 bg-gray-200 text-faded rounded-full my-1 ml-3 focus-within:bg-white focus-within:ring-1 focus-within:ring-primary-base focus-within:text-primary-base'>
      ...
      <div className='mt-5 bg-gray-200 ml-3 rounded-2xl '>
        <div >
        ...
        <div className='my-1 py-2 hover:bg-gray-light block'>
